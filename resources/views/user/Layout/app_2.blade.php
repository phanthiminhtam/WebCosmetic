    ...
    <div id="mobile-menu-offcanvas" class="offcanvas offcanvas-rightside offcanvas-mobile-menu-section">
        ...
        <div class="offcanvas-mobile-menu-wrapper">
            ...
            <div class="mobile-contact-info">
                <div class="logo">
                  <a href="index.html"><img src="/Assets/Front/Users/assets/images/logo/logo_white.png" alt=""></a>
                </div>
    ...
    <div id="offcanvas-about" class="offcanvas offcanvas-rightside offcanvas-mobile-about-section">
        ...
        <div class="mobile-contact-info">
            ...
            <ul class="user-link">
                ...
                <li><a href="{{route('home.checkout')}}">Đặt hàng</a></li>
    ...
    <div id="offcanvas-wishlish" class="offcanvas offcanvas-rightside offcanvas-add-cart-section">
        ...
        <div class="offcanvas-wishlist-wrapper">
            ...
            <ul class="offcanvas-wishlist-action-button">
                <li><a href="{{route('home.wishlist')}}" class="btn btn-block btn-golden">Yêu thích</a></li>
            </ul>
        </div> <!-- End Offcanvas Mobile Menu Wrapper -->
    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">MỸ PHẨM CHÍNH HÃNG</h3>
                        <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Uy tín</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Đảm bảo</a></li>
                                    <li class="active" aria-current="page">Đầy đủ</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $.each(res.list, (index, value) => {
                        str += `<li><a style="color:#fff" href="/admin/productdetail/${value.SpId}">${value.product.ProName}</a></li>`
                    })
