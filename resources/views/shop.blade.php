                            ...
                            <div class="sort-box d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column" data-aos="fade-up"  data-aos-delay="0">
                                ...
                                <div class="sort-tablist d-flex align-items-center">
                                    <ul class="tablist nav sort-tab-btn">
                                        <li><a class="nav-link active" data-bs-toggle="tab" href="#layout-4-grid"><img src="/Assets/Front/Users/assets/images/icons/bkg_grid.png" alt=""></a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="0">
                                                    <div class="image-box">
                                                        <a href="{{route('home.productdetail')}}" class="image-link">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-9.jpg" alt="">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-10.jpg" alt="">
                                                        </a>
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Epicuri per lobortis</a></h6>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="200">
                                                    <div class="image-box">
                                                        <a href="{{route('home.productdetail')}}" class="image-link">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-11.jpg" alt="">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Kaoreet lobortis sagit</a></h6>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="400">
                                                    <div class="image-box">
                                                        <a href="{{route('home.productdetail')}}" class="image-link">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-5.jpg" alt="">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-7.jpg" alt="">
                                                        </a>
                                                        <div class="action-link">
                                                            <div class="action-link-left">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart">Add to Cart</a>
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Condimentum posuere</a></h6>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="600">
                                                    <div class="image-box">
                                                        <a href="{{route('home.productdetail')}}" class="image-link">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Convallis quam sit</a></h6>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="0">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Aliquam lobortis</a></h6>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="400">
                                                    <div class="image-box">
                                                        <a href="{{route('home.productdetail')}}" class="image-link">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-6.jpg" alt="">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-8.jpg" alt="">
                                                        </a>
                                                        <div class="tag">
                                                            <span>sale</span>
                                                        </div>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="600">
                                                    <div class="image-box">
                                                        <a href="{{route('home.productdetail')}}" class="image-link">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-12.jpg" alt="">
                                                            <img src="/Assets/Front/Users/assets/images/product/default/home-1/default-3.jpg" alt="">
                                                        </a>
                                                        <div class="action-link">
                                                            <div class="action-link-left">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="200">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Donec eu libero ac</a></h6>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="400">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Dolorum fuga eget</a></h6>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden" data-aos="fade-up"  data-aos-delay="600">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a href="{{route('home.productdetail')}}">Duis pulvinar obortis</a></h6>
                                                            <ul class="review-star">
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                                <li class="fill"><i class="ion-android-star"></i></li>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    <a href="{{route('home.productdetail')}}" class="product-list-img-link">
                                                    ...
                                                    <div class="product-list-content">
                                                        <h5 class="product-list-link"><a href="{{route('home.productdetail')}}">KAOREET LOBORTIS SAGIT</a></h5>
                                                        <ul class="review-star">
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    ...
                                                    <div class="product-list-content">
                                                        <h5 class="product-list-link"><a href="{{route('home.productdetail')}}">CONDIMENTUM POSUERE</a></h5>
                                                        <ul class="review-star">
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    ...
                                                    <div class="product-list-content">
                                                        <h5 class="product-list-link"><a href="{{route('home.productdetail')}}">ALIQUAM LOBORTIS</a></h5>
                                                        <ul class="review-star">
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    <a href="{{route('home.productdetail')}}" class="product-list-img-link">
                                                        <img class="img-fluid" src="/Assets/Front/Users/assets/images/product/default/home-1/default-7.jpg" alt="" >
                                                        <img class="img-fluid" src="/Assets/Front/Users/assets/images/product/default/home-1/default-8.jpg" alt="" >
                                                    </a>
                                                    <div class="product-list-content">
                                                        <h5 class="product-list-link"><a href="{{route('home.productdetail')}}">CONVALLIS QUAM SIT</a></h5>
                                                        <ul class="review-star">
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    <a href="{{route('home.productdetail')}}" class="product-list-img-link">
                                                        <img class="img-fluid" src="/Assets/Front/Users/assets/images/product/default/home-1/default-9.jpg" alt="">
                                                        <img class="img-fluid" src="/Assets/Front/Users/assets/images/product/default/home-1/default-10.jpg" alt="">
                                                    </a>
                                                    <div class="product-list-content">
                                                        <h5 class="product-list-link"><a href="{{route('home.productdetail')}}">DONEC EU LIBERO AC</a></h5>
                                                        <ul class="review-star">
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
                                                            <li class="fill"><i class="ion-android-star"></i></li>
