...
<div class="row">
    <div class="col-md-8" style="margin:auto">
        <div class="card-box">
            <h3 class="header-title mb-3" style="text-align:center">SỬA NGƯỜI DÙNG</h3>
    ...
    <form class="form-horizontal" role="form" action="{{ route('users.update', $user->id) }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input required  class="form-control" type="text" id="name" name="name" value="{{ old('name',$user->name) }}" placeholder="Tên người dùng...">
            </div>
        </div>
        <div class="form-group row">
            <label for="title" class="col-sm-3 col-form-label" style="font-size: 16px">Email</label>
            <div class="col-sm-9">
                <input required  class="form-control" type="text" id="email" name="email" value="{{ old('email', $user->email) }}" placeholder="Email...">
            </div>
        </div>
        <div class="form-group row">
            <label for="title" class="col-sm-3 col-form-label" style="font-size: 16px">Mật khẩu</label>
            <div class="col-sm-9">
                <input required  class="form-control" type="password" id="password" name="password" value="{{ old('email', $user->password) }}" placeholder="Mật khẩu...">
            </div>
        </div>
