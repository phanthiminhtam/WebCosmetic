...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title" style="text-align:center">THÊM BÀI VIẾT</h4>
            <div class="row">
                <div class="col-12">
                    <div class="p-2">
                        <form class="form-horizontal" role="form" method="post" action="{{route('home2.News.save2')}}">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="simpleinput">Tiêu đề</label>
                                <div class="col-sm-10">
                                    <input type="text" id="simpleinput" name="Title" class="form-control" value="" placeholder="Tiêu đề..." required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="example-date">Thời gian đăng</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="date" name="PublicDate" id="example-date" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="example-fileinput">Hình ảnh</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" name="Image" id="example-fileinput" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group mb-0 justify-content-end row">
                                <div class="col-sm-9">
                                    ...
                                    <button type="" class="btn btn-info waves-effect waves-light">
                                        <a href="{{route('home2.News.index')}}" style="text-decoration-line: none; color:white">Hủy</a>
                                    </button>
                                </div>
                            </div>
                        </form>
