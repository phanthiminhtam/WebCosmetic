                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="index.html">
                                    <span><img src="\Assets\Front\Users\assets\images\logo\logo_black.png" alt="" height="25"></span>
                                </a>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted"> Bạn đã mua hàng thành công! </p>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            ...
                            <p class="text-muted"> <a href="{{route('home.chitietdonhang',$id)}}" class="text-muted font-weight-medium ml-1" style="font-weight:700; font-size:18px">Chi tiết đơn hàng</a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
